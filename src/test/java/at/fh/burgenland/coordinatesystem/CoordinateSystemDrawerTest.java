...
/**
 * Unit tests for the CoordinateSystemDrawer class. This test ensures that the drawAxes() method
 * executes without throwing exceptions and that the canvas is correctly initialized for drawing.
 */
class CoordinateSystemDrawerTest {

  /**
   * Verifies that drawAxes() runs without any exceptions and that the Canvas object has a valid
   * GraphicsContext.
   */
  @Test
