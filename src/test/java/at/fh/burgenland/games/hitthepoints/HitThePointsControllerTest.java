...
public class HitThePointsControllerTest {
    ...
    void userInfoTest(){
        ...
        assertEquals("Benutzer: TestUser", userInfoLabel.getText(), "Der UserInfo-Label sollte 'TestUser' sein.");

        Label userProfileLabel = robot.lookup("#profileLabel").queryAs(Label.class);
        assertEquals("Stimmprofil: MAENNLICH", userProfileLabel.getText(), "Der UserInfo-Label sollte 'TestUser' sein.");
    }
